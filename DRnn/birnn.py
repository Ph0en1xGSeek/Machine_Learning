...
class BiRNN(object):
    ...
    def __init__(self, n_input, n_hidden, n_classes):
        ...
        self.outputs, self.fw, self.bw = tf.contrib.rnn.static_bidirectional_rnn(
            # self.lstm_fw_cell,
            # self.lstm_bw_cell,
            self.gru_fw_cell,
            self.gru_bw_cell,
        ...
        self.mid = tf.nn.softplus(tf.matmul(self.outputs[-1], self.weights) + self.biases)
    ...
    def _initialize_weights(self):
        ...
        self.weights = tf.Variable(xavier_init(2*self.n_hidden, self.n_classes))

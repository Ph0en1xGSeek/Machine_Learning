...
"""Example / benchmark for building a PTB RNN model.
...
class PTBModel(object):
  ...
  def _build_rnn_graph_lstm(self, inputs, config, is_training):
    """Build the inference graph using canonical RNN cells."""
    ...
    # This builds an unrolled RNN for tutorial purposes only.
